...
## 28. Conclusions générales (au terme de la v22, 11 juin 2026)

> Cette section répond directement à la demande : *« donne-moi tes conclusions »*, en synthétisant les vingt-deux éditions et en intégrant la **concurrence sur le marché** et le **coût d'entrée** (la lentille douve B / concurrence C des v7→v22) ainsi que les **prix cibles** (v17→v22).

### 28.1 — Les neuf enseignements structurants
...
### 28.2 — Le palmarès final par couple criticité × décote × douve (indice ≥ 6, tous tris confondus)
...
| 15-27 | **Tokyo Electron, Cleveland-Cliffs, EnerSys, AECOM, Thales, Ajinomoto, NRG, Dell, AT&S, TE Connectivity, Photronics, Advantest, SPIE** *(nouv. v22)* | — | **6** | WFE le moins cher / GOES US / batterie de salle / design DC / **HSM (Euronext)** / **monopole film ABF** / IPP gaz / pelle serveur / substrat EU / connecteur value / photomasques / **ATE étalon le mieux pricé** / **mainteneur multi-technique DC (Euronext)** | Thales **oui (Paris)**, AT&S **oui (Vienne)**, **SPIE oui (Paris)** |
| (5 *quasi-6*) | **Infineon, Microchip** *(v21)*, **Bilfinger** *(nouv. v22)* | IFX.DE / MCHP / GBF.DE | **5** | **Power de l'IA** (SiC/GaN, étiquette « auto cyclique ») / **contrôleur CXL au prix d'un MCU en creux** / **services lifecycle DC (Francfort)** | Infineon & Bilfinger **oui (Francfort)** |

> **Note de lecture du palmarès.** Les **indices 8** restent le **noyau dur** : duopole EDA corrigé (Synopsys), mémoire mal-aimée (SK Hynix, Micron) et gaz-to-power sous-possédé (Energy Transfer). Les **indices 7** se sont **densifiés** au fil des éditions, ajoutant des **goulets de second rang à douve dure** (Onto sur l'inspection HBM4, Itron sur le réseau-software, Ibiden/Shin-Etsu sur les substrats/wafers). Le **pure-play Euronext de cœur du haut du tableau reste Nexans (7)** ; Thales, Ajinomoto et désormais **SPIE (6, le « mainteneur » multi-technique)** complètent côté accessible/monopole.

### 28.3 — Synthèse opérationnelle pour le compte (~1 068 €, eToro/Euronext)
...
- **Top picks Euronext de rotation/ajout :** **Nexans (NEX.PA, 7)** — câble HV, *laggard* value, validé par le déficit cuivre + campus multi-GW + délais réseau 4 ans ; **★ SPIE (SPIE.PA, 6, nouveau v22)** — le **mainteneur multi-technique** du DC (~15× PE), récurrent/local/non-internalisable, carnet DC ↑, étiquette « services à marge fine » en retard.
- **Pépites Euronext de cœur (accessibles) :** **Thales (HO.PA, 6)** — HSM/sécurité, étiquette « défense » en retard ; **Bilfinger (GBF.DE, 5, ★ nouveau v22)** — services lifecycle DC (Francfort) ; **Veolia (VIE.PA, 5, biais ↑)** — eau/cooling DC (validée par CoolIT/Ecolab) ; **Infineon (IFX.DE, 5, v21)** — power de l'IA, étiquette « semi auto cyclique » ; **Heidelberg (HEI.DE, 5, v20)** — béton de l'IA. **Legrand (LR.PA)** — busways/PDU. **Besi (BESI.AS, 4)** & **Prysmian (PRY.MI, 5)** — sur repli.
- **Watchlist US/Asie (eToro), par couple décote×douve :** Onto (7), Itron (7), Synopsys (8, sur maintien de la correction), Micron (8), NRG (6), **Centrus (6, ★ HALEU, biais ↑) / Cameco (combustible)**, Cisco (5), Fortinet (5), Cleveland-Cliffs (6), EnerSys (6), Tokyo Electron (6), Resonac (7), Microchip (5, CXL/cycle), Renesas (5), Auras (5), Yageo (5), Neo (5), Vishay (5), Keysight (4, étalon sur repli), **BWXT (4, forgeron nucléaire sur repli), Ecolab (4, chimie de l'eau sur repli)**.
- **Paris binaires/spéculatifs (taille minuscule) :** 2CRSi (5, two-phase), Silicom (4, DPU — louche), Innodata (3, eval agentique — louche momentum), neoclouds (Nebius, ≤3).
...
> **Conclusion finale.** *En vingt-deux éditions, la cartographie de l'infrastructure IA est devenue exhaustive — de l'atome (silice, GOES, NdFeB, film ABF, **uranium HALEU**) au modèle, en passant par la donnée qui le nourrit et **l'eau/l'électron qui le refroidissent et l'alimentent** —, et le complexe s'est **largement revalorisé**. Le rendement ajusté du risque ne se trouve plus dans le « pas cher en absolu » (rare) mais dans **cinq poches récurrentes** : **(1)** les **dislocations de qualité** (mémoire HBM mal-aimée — SK Hynix, Micron, renforcées par le pooling CXL de l'inférence) ; **(2)** les **dérivées énergie/réseau/nucléaire sous-possédées** (gaz-to-power ET/KMI/NRG, câble Nexans, transfo HD Hyundai, IPP Vistra, réseau-software Itron, **combustible HALEU Centrus/Cameco**) ; **(3)** les **oligopoles/monopoles à étiquette en retard** (EDA Synopsys, HSM Thales, film ABF Ajinomoto, inspection Onto, fonderie TSMC, ciment Heidelberg, power Infineon) ; **(4)** les **consommables récurrents à douve de qualification** (Resonac, JX, Cohu, TOK, étalon Advantest, **chimie de l'eau Ecolab/Veolia**) ; **(5) — ajout v22 — les services d'exécution récurrents, locaux et non-internalisables** que les hyperscalers ne peuvent pas reproduire et que le marché étiquette « à marge fine » (**mainteneur multi-technique SPIE/Bilfinger**). La discipline tient en sept maximes cumulatives : **acheter la faiblesse** ; **offre contrainte ≠ surcapacité** ; **payer la douve, pas la perfection** ; **le rôle critique ne garantit pas la décote** ; **plus la criticité est récente et médiatisée (terres rares, turbines, CPU-host, IPO challenger), plus le multiple est dangereux** ; **plus elle est portée par du logiciel/IP/pure-play (eval de données, power vertical, contrôleur CXL, instrument de validation), plus le marché la price tôt et fort (v21)** ; et — ajout v22 — **plus elle est attaquable par l'IP d'un incumbent ou repose sur un pipeline pré-revenu (challengers d'inférence Cerebras/Groq, développeurs SMR Oklo/NuScale), plus c'est un piège : on possède l'incumbent, pas le challenger ; la dernière décote propre + Euronext est toujours le maillon que l'incumbent ne peut pas remplacer et que le marché trouve ennuyeux (SPIE « services à marge fine » → exécution récurrente du DC).** Tous les prix cibles et indices sont des **jugements d'analyse, sensibles au capex hyperscaler et aux multiples — non des garanties.***
