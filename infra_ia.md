...
## 29. Conclusions générales (au terme de la v23, 12 juin 2026)

> Cette section répond directement à la demande : *« donne-moi tes conclusions »*, en synthétisant les vingt-trois éditions et en intégrant la **concurrence sur le marché** et le **coût d'entrée** (la lentille douve B / concurrence C des v7→v23) ainsi que les **prix cibles** (v17→v23).

### 29.1 — Les dix enseignements structurants
...
### 29.2 — Le palmarès final par couple criticité × décote × douve (indice ≥ 6, tous tris confondus)
...
| 15-30 | **Tokyo Electron, Cleveland-Cliffs, EnerSys, AECOM, Thales, Ajinomoto, NRG, Dell, AT&S, TE Connectivity, Photronics, Advantest, SPIE** *(v22)*, **Soitec, SCREEN Holdings, Kokusai Electric** *(nouv. v23)* | — | **6** | WFE le moins cher / GOES US / batterie de salle / design DC / **HSM (Euronext)** / **monopole film ABF** / IPP gaz / pelle serveur / substrat EU / connecteur value / photomasques / **ATE étalon le mieux pricé** / **mainteneur multi-technique DC (Euronext)** / **★ monopole SOI-photonique « mobile mourant » (Euronext)** / **oligopole *cleaning track* « japonais cyclique » ~9,6×** / **ALD-furnace WFE value** | Thales **oui (Paris)**, AT&S **oui (Vienne)**, SPIE **oui (Paris)**, **Soitec oui (Paris)** |
| (5 *quasi-6*) | **Infineon, Microchip** *(v21)*, **Bilfinger** *(v22)*, **Aixtron** *(nouv. v23)* | IFX.DE / MCHP / GBF.DE / AIXA.DE | **5** | **Power de l'IA** (SiC/GaN, étiquette « auto cyclique ») / **contrôleur CXL au prix d'un MCU en creux** / **services lifecycle DC (Francfort)** / **MOCVD GaN/SiC/photonique (Francfort)** | Infineon, Bilfinger & Aixtron **oui (Francfort)** |

> **Note de lecture du palmarès.** Les **indices 8** restent le **noyau dur** : duopole EDA corrigé (Synopsys), mémoire mal-aimée (SK Hynix, Micron) et gaz-to-power sous-possédé (Energy Transfer). Les **indices 7** se sont **densifiés** au fil des éditions, ajoutant des **goulets de second rang à douve dure** (Onto sur l'inspection HBM4, Itron sur le réseau-software, Ibiden/Shin-Etsu sur les substrats/wafers). Les **indices 6** s'élargissent en v23 au **substrat & à la WFE « cyclique »** (Soitec, SCREEN, Kokusai). Le **pure-play Euronext de cœur du haut du tableau reste Nexans (7)** ; Thales, Ajinomoto, SPIE et désormais **★ Soitec (6, le monopole SOI-photonique déguisé en « mobile mourant »)** complètent côté accessible/monopole.

### 29.3 — Synthèse opérationnelle pour le compte (~1 068 €, eToro/Euronext)
- **Détenus à conserver/renforcer comme lignes infra-IA :** Air Liquide (6, gaz fabs + hélium **+ eau/cooling, biais ↑**), Schneider (5, power+cooling), STMicro (5, 800 VDC + SiPh **+ dalle de puissance verticale, biais ↑**). *Réévalués comme infra IA, pas comme défensives/cycliques.*
...
- **Watchlist US/Asie (eToro), par couple décote×douve :** Onto (7), Itron (7), Synopsys (8, sur maintien de la correction), Micron (8), NRG (6), **SCREEN Holdings (6, ★ WFE value ~9,6×) / Kokusai Electric (6, ★ ALD-furnace value)**, **Centrus (6, HALEU, biais ↑) / Cameco (combustible)**, Cisco (5), Fortinet (5), Cleveland-Cliffs (6), EnerSys (6), Tokyo Electron (6), Resonac (7), Microchip (5, CXL/cycle), Renesas (5), Auras (5), Yageo (5), Neo (5), Vishay (5), Keysight (4, étalon sur repli), **Silicon Motion (4, eSSD sur repli) / Axcelis (4, implant sur repli/arb Veeco)**, **BWXT (4, forgeron nucléaire sur repli), Ecolab (4, chimie de l'eau sur repli)**.
...
- **À éviter / repli marqué seulement (rôle pricé / perfection / douve inversée) :** Arm, AMD, MP Materials, GE Vernova, Vertiv (multiple), Coherent, Lumentum, Camtek, Modine, Datadog, CrowdStrike, Tesla (VPP), Corning, Fabrinet, Quanta Services, Caterpillar, Vicor & MPWR (power vertical pure-play), Astera (CXL leader), Teradyne (ATE re-raté), TaskUs (value trap données), **Cerebras (challenger à douve inversée), Oklo/NuScale/Nano Nuclear (développeurs SMR pré-revenus)**, **Bloom Energy (SOFC ~149× BPA), Credo/MACOM (pont re-raté ~164×/« absurde »), FuelCell/Plug Power**.

> **Conclusion finale.** *En vingt-trois éditions, la cartographie de l'infrastructure IA est devenue exhaustive — de l'atome (silice, **substrat SOI-photonique**, GOES, NdFeB, film ABF, **uranium HALEU**) au modèle, en passant par la donnée qui le nourrit et **l'eau/l'électron qui le refroidissent et l'alimentent** —, et le complexe s'est **largement revalorisé, jusqu'aux niches de 3ᵉ rang**. Le rendement ajusté du risque ne se trouve plus dans le « pas cher en absolu » (quasi-éteint sur les couches critiques) mais dans **cinq poches récurrentes** : **(1)** les **dislocations de qualité** (mémoire HBM mal-aimée — SK Hynix, Micron, renforcées par le pooling CXL de l'inférence et la demande NAND/QLC des eSSD) ; **(2)** les **dérivées énergie/réseau/nucléaire sous-possédées** (gaz-to-power ET/KMI/NRG, câble Nexans, transfo HD Hyundai, IPP Vistra, réseau-software Itron, **combustible HALEU Centrus/Cameco**) ; **(3)** les **oligopoles/monopoles à étiquette en retard** (EDA Synopsys, HSM Thales, film ABF Ajinomoto, **substrat SOI-photonique Soitec**, inspection Onto, fonderie TSMC, ciment Heidelberg, power Infineon, **oligopole WFE « japonais cyclique » SCREEN/Kokusai**) ; **(4)** les **consommables récurrents à douve de qualification** (Resonac, JX, Cohu, TOK, étalon Advantest, **chimie de l'eau Ecolab/Veolia**) ; **(5)** les **services d'exécution récurrents, locaux et non-internalisables** que les hyperscalers ne peuvent pas reproduire et que le marché étiquette « à marge fine » (**mainteneur multi-technique SPIE/Bilfinger**). La discipline tient en huit maximes cumulatives : **acheter la faiblesse** ; **offre contrainte ≠ surcapacité** ; **payer la douve, pas la perfection** ; **le rôle critique ne garantit pas la décote** ; **plus la criticité est récente et médiatisée (terres rares, turbines, CPU-host, IPO challenger, pile à combustible), plus le multiple est dangereux** ; **plus elle est portée par du logiciel/IP/pure-play, plus le marché la price tôt et fort (v21)** ; **plus elle est attaquable par l'IP d'un incumbent ou repose sur un pipeline pré-revenu (challengers d'inférence, développeurs SMR), plus c'est un piège : on possède l'incumbent, pas le challenger (v22)** ; et — ajout v23 — **au terme du re-rating général, la dernière décote propre n'est plus un multiple bas (introuvable) mais une étiquette structurellement fausse : Soitec « mobile mourant » → monopole du substrat SOI-photonique ; SCREEN/Kokusai « japonais cycliques » → oligopole WFE ; et quand une « value perpétuelle » (implant Axcelis, contrôleur Silicon Motion) se fait re-rater à 50×+, c'est le signal d'achèvement du thème — on rote vers l'étiquette encore en retard, jamais vers le momentum.** Tous les prix cibles et indices sont des **jugements d'analyse, sensibles au capex hyperscaler et aux multiples — non des garanties.***
