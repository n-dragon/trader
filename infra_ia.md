...
## 30. Conclusions générales (au terme de la v24, 13 juin 2026)

> Cette section répond directement à la demande : *« donne-moi tes conclusions »*, en synthétisant les vingt-quatre éditions et en intégrant la **concurrence sur le marché** et le **coût d'entrée** (la lentille douve B / concurrence C des v7→v24) ainsi que les **prix cibles** (v17→v24).

### 30.1 — Les onze enseignements structurants
...
### 30.2 — Le palmarès final par couple criticité × décote × douve (indice ≥ 6, tous tris confondus)
...
| 15-31 | **Tokyo Electron, Cleveland-Cliffs, EnerSys, AECOM, Thales, Ajinomoto, NRG, Dell, AT&S, TE Connectivity, Photronics, Advantest, SPIE** *(v22)*, **Soitec, SCREEN Holdings, Kokusai Electric** *(v23)*, **Mitsubishi Electric** *(nouv. v24)* | — | **6** | WFE le moins cher / GOES US / batterie de salle / design DC / **HSM (Euronext)** / **monopole film ABF** / IPP gaz / pelle serveur / substrat EU / connecteur value / photomasques / **ATE étalon le mieux pricé** / **mainteneur multi-technique DC (Euronext)** / **★ monopole SOI-photonique « mobile mourant » (Euronext)** / **oligopole *cleaning track* « japonais cyclique » ~9,6×** / **ALD-furnace WFE value** / **★ oligopole GIS/HVDC déguisé en « conglomérat japonais » (péage des ~2 300 GW en file)** | Thales **oui (Paris)**, AT&S **oui (Vienne)**, SPIE **oui (Paris)**, **Soitec oui (Paris)** |
| (5 *quasi-6*) | **Infineon, Microchip** *(v21)*, **Bilfinger** *(v22)*, **Aixtron** *(v23)*, **Cummins, Wärtsilä, onsemi, Hitachi** *(nouv. v24)* | IFX.DE / MCHP / GBF.DE / AIXA.DE / CMI / WRT1V.HE / ON / 6501.T | **5** | **Power de l'IA** (SiC/GaN, étiquette « auto cyclique ») / **contrôleur CXL au prix d'un MCU en creux** / **services lifecycle DC (Francfort)** / **MOCVD GaN/SiC/photonique (Francfort)** / **motoriste RICE diversifié (genset DC)** / **RICE off-grid >2,4 GW DC US (Helsinki)** / **SiC pour le 800 VDC** / **Hitachi Energy (grid/HVDC) dans le conglomérat** | Infineon, Bilfinger & Aixtron **oui (Francfort)**, Wärtsilä **oui (Helsinki)** |

> **Note de lecture du palmarès.** Les **indices 8** restent le **noyau dur** : duopole EDA corrigé (Synopsys), mémoire mal-aimée (SK Hynix, Micron) et gaz-to-power sous-possédé (Energy Transfer). Les **indices 7** se sont **densifiés** au fil des éditions, ajoutant des **goulets de second rang à douve dure** (Onto sur l'inspection HBM4, Itron sur le réseau-software, Ibiden/Shin-Etsu sur les substrats/wafers). Les **indices 6** s'élargissent en v23 au **substrat & à la WFE « cyclique »** (Soitec, SCREEN, Kokusai) puis en v24 au **switchgear GIS « conglomérat »** (Mitsubishi Electric). Le **pure-play Euronext de cœur du haut du tableau reste Nexans (7)** ; Thales, Ajinomoto, SPIE et désormais **★ Soitec (6, le monopole SOI-photonique déguisé en « mobile mourant »)** complètent côté accessible/monopole, tandis que **Mitsubishi Electric (6, l'oligopole GIS/HVDC déguisé en conglomérat japonais)** est la « value migrée » de la v24 côté réseau (hors-Euronext).

### 30.3 — Synthèse opérationnelle pour le compte (~1 068 €, eToro/Euronext)
...
- **Top picks Euronext de rotation/ajout :** **Nexans (NEX.PA, 7)** — câble HV, *laggard* value, validé par le déficit cuivre + campus multi-GW + délais réseau 4 ans ; **★ Soitec (SOI.PA, 6, nouveau v23)** — le **monopole du substrat SOI-photonique** (~95 %, wafer *sous* chaque transceiver SiPh/CPO), **pricé en « fournisseur mobile mourant »** (CA −34 %), coté Paris ; **SPIE (SPIE.PA, 6, v22)** — le **mainteneur multi-technique** du DC (~15× PE), récurrent/local, étiquette « services à marge fine » en retard.
