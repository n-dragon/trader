...
> **Dernière mise à jour :** 2026-08-10 (rafraîchissement #8 — **2ᵉ fenêtre calme consécutive côté `buy` sénateurs (3–10 août 2026)**, cohérent avec la pause estivale du Sénat : aucun **nouvel achat d'action de sénateur** isolable de façon fiable. L'actualité STOCK Act reste dominée par une **vague de divulgations tardives**, mais **côté Chambre** : **Julie Johnson (D-TX)** — 76 trades divulgués en retard (76 076 $–1,14 M$), **amende de 200 $** ; s'ajoutant à **Julia Letlow (R-LA, 210+ retards)** → **hors périmètre sénateurs**. Côté Sénat, l'affaire **Armstrong (R-OK)** reste la référence (700+ retards, 3,24–16,05 M$), déjà tabulée. Réglementaire : **H.R. 7008 (Stop Insider Trading Act)** toujours **en attente au Sénat** (aucune commission saisie, aucun vote programmé). Contexte de fond : analyse CNN / Foreign Policy Journal — **56 % des trades du Congrès (6 170 / 11 016 sur 16 mois) recoupent un secteur voté par le membre**. Précédent : rafraîchissement #7, 2026-08-03.)
