...
> **Dernière mise à jour :** 2026-08-17 (rafraîchissement #9 — **fin de fenêtre calme : un nouvel achat de sénateur isolé**. **Gary Peters (D-MI)** a acheté **Realty Income (O)** — REIT net-lease « The Monthly Dividend Company » (673 dividendes mensuels consécutifs) — **le 23 juil. 2026**, tranche **1–15 k$**, **divulgué le 7 août** (alerte MarketBeat du 11/08). Par ailleurs, une **ligne d'achat nouvellement isolée** dans le panier *direct indexing* d'**Armstrong (R-OK)** : **Nebius Group (NBIS)**, infra IA/cloud (ex-Yandex), **1–15 k$ le 30 mars 2026** (J+6 de sa prise de fonction), aujourd'hui **~+130-150 %** sur le papier. Côté transparence, **Ron Wyden (D-OR)** — **auteur du STOCK Act** — est épinglé pour la déclaration tardive/incomplète d'un **échange d'actions à six chiffres de son épouse (2025)**, qualifié d'« *automatique, sans instruction de la sénatrice* » (échange, hors périmètre `buy`). Vague d'enforcement toujours active **côté Chambre** (Michael Rulli R-OH : 22 retards ; « trois nouveaux élus » le 14/08) → **hors périmètre sénateurs**. Réglementaire : **H.R. 7008 (Stop Insider Trading Act)** toujours **en attente au Sénat** (aucun vote programmé). Précédent : rafraîchissement #8, 2026-08-10.)
